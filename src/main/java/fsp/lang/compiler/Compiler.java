...
public class Compiler {
  ...
  private void start() {
    String impl = "fsp/lang/type/Lambda";
    if (isMacro) {
      impl = "fsp/lang/type/Macro";
    }
  ...
  private Object compileSymbol(Symbol symbol) {
    if (isQuoted() && !symbol.getValue().equals("nil")) {
      mv.visitTypeInsn(Opcodes.NEW, "fsp/lang/type/Symbol");
      mv.visitInsn(DUP);
      mv.visitLdcInsn(symbol.getValue());
      mv.visitMethodInsn(
          INVOKESPECIAL, "fsp/lang/type/Symbol", "<init>", "(Ljava/lang/String;)V", false);
      return symbol;
    }
    ...
    mv.visitMethodInsn(
        INVOKESTATIC,
        "fsp/lang/Environment",
        "get",
        "(Lfsp/lang/type/Symbol;)Ljava/lang/Object;",
        false);
  ...
  private Object compileCons(Cons cons) {
    ...
    if (first instanceof Cons) {
      ...
      if (compiled instanceof Lambda) {
        mv.visitTypeInsn(Opcodes.NEW, "fsp/lang/function/Apply");
        mv.visitInsn(DUP);
  ...
  private void compileConsWithoutEvaluating(Cons cons) {
    ...
    while (cons != null) {
      ...
      mv.visitTypeInsn(Opcodes.NEW, "fsp/lang/type/Cons");
      mv.visitInsn(DUP);
      mv.visitMethodInsn(INVOKESPECIAL, "fsp/lang/type/Cons", "<init>", "()V", false);
      _compile(cons.getCar());
      mv.visitMethodInsn(
          INVOKEVIRTUAL,
          "fsp/lang/type/Cons",
          "setCar",
          "(Ljava/lang/Object;)Lfsp/lang/type/Cons;",
          false);
      cons = cons.getCdr();
    }
    ...
    while (cons != null) {
      mv.visitMethodInsn(
          ...
          "fsp/lang/type/Cons",
          "setCdr",
          "(Lfsp/lang/type/Cons;)Lfsp/lang/type/Cons;",
          false);
      cons = cons.getCdr();
    }
  }
  ...
  private void compileDotSpecialForm(Cons cons) {
    ...
    mv.visitMethodInsn(INVOKESTATIC, "fsp/lang/reflect/Reflector", "invoke", descriptor, false);
  }
  ...
  private void compileDefSpecialForm(Cons cons) {
    ...
    mv.visitMethodInsn(
        ...
        "fsp/lang/Environment",
        "put",
        "(Lfsp/lang/type/Symbol;Ljava/lang/Object;)Ljava/lang/Object;",
        false);
