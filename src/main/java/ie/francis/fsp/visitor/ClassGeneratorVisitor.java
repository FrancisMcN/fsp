...
//      DataType symbol = environment.get(first.value());
//      if (isVariadic(symbol)) {
//        compileArrayOfArguments(nodes, false);
//      } else {
//        compileArguments(nodes, false);
//      }
//      try {
//        compileMacroExpand(symbol);
...
//      DataType symbol = environment.get(first.value());
//      if (isVariadic(symbol)) {
//        compileArrayOfArguments(nodes, true);
//      } else {
//        compileArguments(nodes, true);
//      }
...
//
//    int id = lvs.newLocal(org.objectweb.asm.Type.getType("Lie/francis/fsp/runtime/helper/ConsBuilder"));
...
//  }
//
//  private void compileMacroSpecialForm(List<Node> nodes) {
//
//    String macroName = nodes.get(0).value();
...
//
//  private void compileFunctionCall(DataType symbol) {
...
//  }
//
//  private void compileMacroExpand(DataType symbol) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
//    String owner = symbol.name().split("\\.")[0];
//    String macroName = symbol.name().split("\\.")[1];
//    Class<?> clazz = environment.loadClass(owner);
////    clazz.getMethod("run", Object.class, Object.class, Object.class).invoke(null, new Object(), new Object(), new Object());
////    System.out.println("method: " + Arrays.toString(clazz.getMethods()));
//    mv.visitMethodInsn(INVOKESTATIC, owner, macroName, symbol.descriptor(), false);
//  }
//
//  private void compileArguments(List<Node> nodes, boolean evaluate) {
//    if (!evaluate) {
//      this.quoteDepth++;
//    }
//    for (Node node : nodes) {
...
//  }
//
//  private void compileArrayOfArguments(List<Node> nodes, boolean evaluate) {
...
//        DataType symbol = environment.get(value);
//        return symbol.type() == Type.FUNCTION;
//      }
//    }
//    return false;
//  }
...
//      if (environment.contains(value)) {
//        DataType symbol = environment.get(value);
//        return symbol.type() == Type.MACRO;
//      }
//    }
//    return false;
//  }
//
//  private boolean isVariadic(DataType function) {
