...
public class ScannerTest {
    ...
    public void nextReturnsCorrectTokensForSimpleInput() {
        ...
        assertEquals(new Token(Type.RMACRO, "'", 1), scanner.next());
    ...
    @Test
    void isReaderMacroIdentifiesReaderMacros() {
        assertTrue(scanner.isReaderMacro('\''));
        assertTrue(scanner.isReaderMacro('@'));
        assertFalse(scanner.isReaderMacro('#'));
    }
